...
function preload() {
  playerImg = loadImage('monkeypoxGame/boy-removebg-preview.png', () => console.log('Player image loaded'), handleImageError);
  vaccineImg = loadImage('monkeypoxGame/vacs-removebg-preview.png', () => console.log('Vaccine image loaded'), handleImageError);
  virusImg = loadImage('monkeypoxGame/virus-removebg-preview.png', () => console.log('Virus image loaded'), handleImageError);
  bgImg = loadImage('monkeypoxGame/back.png ', () => {
